...
const ITEMS = [
  { id: 'potion', name: '체력 물약', icon: '🧪', cost: 50, cat: '소모품', consumable: true, stack: 5, desc: '사용 시 15초 동안 체력을 150 회복합니다. (숫자키로 사용)' },
  ...
  { id: 'destroyer', name: '파괴의 대검', icon: '💥', cost: 3400, cat: '완성', stats: { ad: 70, crit: 0.2, critDmg: 0.35 }, desc: '치명타 피해량 +35%' },
  { id: 'rapidfire', name: '폭풍 연사궁', icon: '🎯', cost: 2600, cat: '완성', stats: { asPct: 0.35, crit: 0.2, msPct: 0.07 } },
  { id: 'bloodthirst', name: '피의 갈증', icon: '🍷', cost: 3400, cat: '완성', stats: { ad: 55, lifesteal: 0.18 } },
  { id: 'giantHeart', name: '거인의 심장', icon: '💗', cost: 3000, cat: '완성', stats: { hp: 800, regen: 8 } },
  { id: 'thornmail', name: '가시 갑옷', icon: '🌵', cost: 2700, cat: '완성', stats: { armor: 70, hp: 350, thorns: 1 }, desc: '기본 공격을 받으면 공격자에게 (15 + 방어력의 15%) 고정 피해' },
  { id: 'spirit', name: '정령의 형상', icon: '🔮', cost: 2800, cat: '완성', stats: { mr: 60, hp: 450, regen: 5 } },
];
